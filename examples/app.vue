  ...
  <div class="container">
    ...
    <div class="operate">
      <el-form :inline="true">
        <el-col>
          <el-form-item>
            <span style="padding-left:0" class="tips"> 💡 component properties start with ':' as prefix and assign the default value to the initial value </span>
          </el-form-item>
        </el-col>
        <el-col>
        ...
        <el-col>
          <el-form-item label="item amount">
            <el-input-number v-model="list" :min="1" :max="10" />
          </el-form-item>
          <el-form-item label=":display-amount">
            <el-input-number v-model="displayAmount" :min="2" :max="10" />
          </el-form-item>
        </el-col>
        <el-col>
          <el-form-item label=":item-width">
            <div style="width:300px">
              <el-slider v-model="itemWidth" :min="20" :max="170" />
            </div>
          </el-form-item>
        ...
        <el-col>
          ...
          <el-form-item label=":arrow-area-width">
            <div style="width:300px">
              <el-slider v-model="arrowAreaWidth"
                         :min="30"
                         :max="100" />
            </div>
          </el-form-item>
        ...
        <el-col>
          <el-form-item label=":timing-function">
            <el-select style="width:260px" v-model="timingFuntion" placeholder="timing function">
              <el-option
            ...
            <span class="tips">
              ...
              <a style="color:seagreen" target="_blank" href="https://developer.mozilla.org/zh-CN/docs/Web/CSS/timing-function">
